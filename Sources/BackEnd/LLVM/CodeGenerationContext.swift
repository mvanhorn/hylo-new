...
extension Program {
  ...
  public func compileToLLVM(_ module: FrontEnd.Module.ID, target: consuming TargetMachine) throws -> SwiftyLLVM.Module {
    var llvm = try SwiftyLLVM.Module("MainModule", targetMachine: target)
